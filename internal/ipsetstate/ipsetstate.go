...
// и периодически сбрасывает его на диск. Используемая версия библиотеки
// github.com/crazytypewriter/ipset (v0.1.1-0.20260502…) не умеет читать
// содержимое сета (нет LIST/DUMP), поэтому состояние ведём сами.
// Известное расхождение: продления таймеров правилом -j SET --exist
// приложению не видны — файл состояния остаётся «нижней границей» того,
// что реально лежит в сетах.
package ipsetstate
